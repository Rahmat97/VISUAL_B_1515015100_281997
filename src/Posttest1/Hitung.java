...
public class Hitung extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbtmb.setBackground(new java.awt.Color(51, 255, 51));
        ...
        rbkrg.setBackground(new java.awt.Color(51, 255, 204));
        buttonGroup1.add(rbkrg);
        rbkrg.setText("Kurang");

        rbkli.setBackground(new java.awt.Color(153, 255, 153));
        buttonGroup1.add(rbkli);
        rbkli.setText("Kali");

        rbbgi.setBackground(new java.awt.Color(204, 255, 204));
        buttonGroup1.add(rbbgi);
        rbbgi.setText("Bagi");

        jLabel4.setFont(new java.awt.Font("a song for jennifer", 0, 18)); // NOI18N
